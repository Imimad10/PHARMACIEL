...
if is_admin:
    for extra_page in ["Automatisation", "Liste des Lots", "Répartition Zones", "Analyse Réclamations", "Pointage Expéditeur", "Inventaire Triple", "Pointage Marchandise", "Assistant IA", "Transferts", "Coordination", "Qualité IA", "Mon Coin", "Briefing IA", "Maintenance", "Académie", "Prévisions", "Mode Meeting", "Page de Garde"]:
...
CATEGORIES = {
    ...
    "📊 SUPERVISION": ["Dashboard", "Analyse Rotation", "Prévisions", "Mode Meeting", "Analyse Réclamations", "Suivi", "Dashboard Premium"],
