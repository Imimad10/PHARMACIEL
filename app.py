...
CATEGORIES = {
    ...
    "📝 POINTAGES & FLUX": ["Pointage", "Pointage Expéditeur", "Page de Garde", "Recouvrement", "Logistique", "Scanneur QR", "Scan Mobile", "Transferts", "Clients", "Chèques", "Portail B2B", "Retours & Avoirs", "Campagnes & Remises"],
